#%%[markdown]
# For demo purpose
# Slightly modified version of Standard solver for snake using Hamiltonian Path 
# [Reference](https://github.com/CheranMahalingam/Snake_Hamiltonian_Cycle_Solver/blob/master/Snake_Solver.py)
...
class Fruit(object):
    ...
    def draw_fruit(self, surface):
        ...
        pg.draw.rect(surface, self.color, self.fruit)
...
class Snake(object):
    ...
    def __init__(self):
        ...
        self.body = deque()
        self.segment = deque()
        self.head_color = pg.Color(0, 155, 0)
        self.body_color = pg.Color(0, 100, 0)
...
pg.display.set_caption('Solver!')
# Load image and set icon
image = pg.image.load('Snake.png')
